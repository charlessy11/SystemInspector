...
{\em proc\+\_\+dir} & the location of procfs \\
\hline
{\em model\+\_\+buf} & stores the cpu model name \\
\hline
{\em buf\+\_\+sz} & buf\+\_\+sz size\\
\hline
\end{DoxyParams}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
counter the sum of processing units 
\end{DoxyReturn}
...
{\footnotesize\ttfamily double pfs\+\_\+cpu\+\_\+usage (\begin{DoxyParamCaption}\item[{char $\ast$}]{procfs\+\_\+dir,  }\item[{struct \mbox{\hyperlink{structcpu__stats}{cpu\+\_\+stats}} $\ast$}]{prev,  }\item[{struct \mbox{\hyperlink{structcpu__stats}{cpu\+\_\+stats}} $\ast$}]{curr }\end{DoxyParamCaption})}

Retrieves cpu usage of the machine


\begin{DoxyParams}{Parameters}
{\em procfs\+\_\+dir} & the location of procfs \\
\hline
{\em \mbox{\hyperlink{structcpu__stats}{cpu\+\_\+stats}}} & $\ast$prev input that represents the last CPU usage state \\
\hline
{\em \mbox{\hyperlink{structcpu__stats}{cpu\+\_\+stats}}} & $\ast$curr output that represents the current CPU usage state, and will be passed back in to pfs\+\_\+load\+\_\+avg on its next call\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
cpu\+\_\+usage the cpu usage 
\end{DoxyReturn}
...
Creates memory for \mbox{\hyperlink{structtask__stats}{task\+\_\+stats}} structs

\begin{DoxyReturn}{Returns}
tstats the \mbox{\hyperlink{structtask__stats}{task\+\_\+stats}} structs 
\end{DoxyReturn}
...
Frees memory for \mbox{\hyperlink{structtask__stats}{task\+\_\+stats}} structs


\begin{DoxyParams}{Parameters}
{\em tstats} & the \mbox{\hyperlink{structtask__stats}{task\+\_\+stats}} structs \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em time} & the uptime(in seconds) \\
\hline
{\em uptime\+\_\+buf} & stores the formatted uptime\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 if success 
...
{\em proc\+\_\+dir} & the location of procfs \\
\hline
{\em hostname\+\_\+buf} & stores the hostname \\
\hline
{\em buf\+\_\+sz} & buf\+\_\+sz size\\
\hline
\end{DoxyParams}
...
{\em proc\+\_\+dir} & the location of procfs \\
\hline
{\em version\+\_\+buf} & stores the kernel version \\
\hline
{\em buf\+\_\+sz} & buf\+\_\+sz size\\
\hline
\end{DoxyParams}
...
{\footnotesize\ttfamily struct \mbox{\hyperlink{structmem__stats}{mem\+\_\+stats}} pfs\+\_\+mem\+\_\+usage (\begin{DoxyParamCaption}\item[{char $\ast$}]{procfs\+\_\+dir }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 if success, or EXIT\+\_\+\+FAILURE if otherwise 
\end{DoxyReturn}
